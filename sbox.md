...
- [Альтернативный метод для YouTube](#альтернативный-метод-для-youtube)
  - [1. Настройка RayKos](#1-настройка-raykos)
...
- Установите RayKos
- На главном экране нажмите большую кнопку (при первом запуске один раз разрешите VPN)
- Готово: лучшие параметры обхода уже встроены, настраивать ничего не нужно
- После включения устройства RayKos запускается автоматически

## 2. Настройка SmartTube

- Установите вариант **arm64_v8a** [SmartTube](https://github.com/yuliskov/SmartTube/releases/latest)
- Если RayKos подключен через VPN — SmartTube работает сразу, без каких-либо настроек
- Если нужен явный прокси:
